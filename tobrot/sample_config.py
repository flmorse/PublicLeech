...
class Config:
    ...
    TG_BOT_TOKEN = get_config("TG_BOT_TOKEN", "1877753406:AAEy1yKx7yUAFIOu0VbwtsEGMW3qBw_oxCk")
    # The Telegram API things
    APP_ID = int(get_config("APP_ID", 1957706))
    ...
    # in the bot
    SUDO_USERS = int(get_config("SUDO_USERS", 1340109095))
